    ...
    return (
        <nav className='bg-white flex justify-between w-screen px-[10vh]'>
            ...
            <div className='flex gap-5 items-center'>
                <NavLink to="/create" className="flex items-center gap-1 bg-black w-max text-white py-2 px-4 rounded hover:bg-black/70 h-max">
                    <Add />
                    <span>Create a new employee</span>
                </NavLink>
                <NavLink to="/list" className="flex items-center gap-1 bg-black w-max text-white py-2 px-4 rounded hover:bg-black/70 h-max">
                    <List />
